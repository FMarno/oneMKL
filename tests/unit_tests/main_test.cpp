...
int main(int argc, char** argv) {
    ...
    !defined(ENABLE_PORTFFT_BACKEND_INTEL_CPU)
                        if (dev.is_cpu())
                            continue;
#endif
#if !defined(ENABLE_MKLGPU_BACKEND) && !defined(ENABLE_PORTBLAS_BACKEND_INTEL_GPU) && \
    !defined(ENABLE_PORTFFT_BACKEND_INTEL_GPU)
    ...
    !defined(ENABLE_CUFFT_BACKEND) && !defined(ENABLE_PORTFFT_BACKEND_NVIDIA_GPU)
    ...
    !defined(ENABLE_ROCFFT_BACKEND) && !defined(ENABLE_PORTFFT_BACKEND_AMD_GPU)
