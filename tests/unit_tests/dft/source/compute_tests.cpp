...
#define INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_COMPLEX_COMPLEX(PLACE, STORAGE) \
    INSTANTIATE_TEST(SINGLE, COMPLEX, PLACE, , STORAGE)                              \
    INSTANTIATE_TEST(SINGLE, REAL, PLACE, , STORAGE)                                 \
    INSTANTIATE_TEST(DOUBLE, COMPLEX, PLACE, , STORAGE)                              \
    INSTANTIATE_TEST(DOUBLE, REAL, PLACE, , STORAGE)

#define INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_REAL_REAL(PLACE, STORAGE) \
    INSTANTIATE_TEST(SINGLE, COMPLEX, PLACE, real_real_, STORAGE)              \
    INSTANTIATE_TEST(DOUBLE, COMPLEX, PLACE, real_real_, STORAGE)

#define INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_PLACE_LAYOUT(STORAGE)              \
    INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_COMPLEX_COMPLEX(in_place, STORAGE)     \
    INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_REAL_REAL(in_place, STORAGE)           \
    INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_COMPLEX_COMPLEX(out_of_place, STORAGE) \
    INSTANTIATE_TEST_DIMENSIONS_PRECISION_DOMAIN_REAL_REAL(out_of_place, STORAGE)
